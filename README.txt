This is the static page codebase for ghosTM55's personal website.
It used the template from "Aerial by HTML5 UP", below is the original README.txt, thanks to @ajlkn for this amazing template!
