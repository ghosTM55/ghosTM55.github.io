...
> An experimental personal website built with Codex prompts.
>
> 一个用 Codex 提示词完成的实验性个人官网。

## 中文

这是我的一个实验性个人官网项目。

这是我第一次使用 Codex 完成的站点实验。在这个过程中，我没有使用设计类 skill 或额外设计工具，主要只靠提示词不断调整和实现。我先拿自己的个人官网做了实验，目前觉得效果还不错。

桌面端首页可以通过 `ssh -Y $THOMAS@earth` 入口进入主站体验。移动端下，我暂时隐藏了这个入口。

## English

This is an experimental personal website project.
